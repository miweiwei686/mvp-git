package com.example.miwei.mvptest.common.view;
...
public class ScrollLinearLayout extends LinearLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.d("mwww","headview height : " + String.valueOf(maxY) + "mHeadHeight : " + mHeadHeight);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (flag2 && shiftY > mTouchSlop && shiftY > shiftX && (!isSticked() || mHelper
                        .isTop())) {
                ...
                if (Math.abs(moveDistanceY) > mScrollMinY && (Math.abs(moveDistanceY) * 0.1 >
    ...
    public void isCanScroll(boolean canScroll) {
